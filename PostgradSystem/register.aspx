                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="student" role="tabpanel" aria-labelledby="student-tab">
                                            <div class="mt-2">
                                                ...
                                                <asp:Button id="studentSubmit" type="submit" CssClass="btn btn-primary" OnClick="studentSubmit_OnServerClick" Text="Register" runat="server"/>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="supervisor" role="tabpanel" aria-labelledby="supervisor-tab">
                                            <div class="mt-2">
                                                ...
                                                <asp:Button id="supervisorRegsister" type="submit" CssClass="btn btn-primary" OnClick="supervisorRegsister_OnClick" Text="Register" runat="server"/>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="examiner" role="tabpanel" aria-labelledby="examiner-tab">
                                            <div class="mt-2">
                                                ...
                                                <asp:Button id="examinerRegister" type="submit" CssClass="btn btn-primary" OnClick="examinerRegister_OnClick" Text="Register" runat="server"/>
                                            </div>
                                        </div>
                                    </div>
                                </form>
